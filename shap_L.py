...
def loadPD(filepath='/Users/RChenLab/Documents/All_MATLAB_files/SharpnesStudy/LFP_analyses/Files/dataL_exc.mat'):
    '''
    ...
    ecog : dict
        ...
        'B' : subject-by-time array for PD patients pre-med
        'D' : subject-by-time array for PD patients on med
    '''
...
def _blankecog(S=14, dtype=object):
    ecog = {}
